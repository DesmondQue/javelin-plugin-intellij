...
This technique is called **Spectrum-Based Fault Localization (SBFL)**. The plugin wraps the [javelin-cli](https://github.com/DesmondQue/javelin-cli) engine and brings it into IntelliJ IDEA as a one-click workflow with in-editor highlighting. Because SBFL works by analyzing your project's own code coverage, it is most effective when the fault is in your codebase rather than in an external library or API.
